...
namespace EOM.Game.Server.Core.NWNX
{
    ...
    public class EffectPlugin
    {
        ...
        public static NWNX_EffectUnpacked GetTrueEffect(uint oObject, int nIndex)
        {
            ...
            return __NWNX_Effect_ResolveUnpack(0);
        }
        ...
        // @}
        public static NWNX_EffectUnpacked __NWNX_Effect_ResolveUnpack(int bLink = 1)
        {
        ...
        public static void __NWNX_Effect_ResolvePack(NWNX_EffectUnpacked e, int bReplace = 0)
        {
            if (bReplace == 0)
                NWNXPushInt(e.nType);
