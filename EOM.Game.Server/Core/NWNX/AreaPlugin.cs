...
namespace EOM.Game.Server.Core.NWNX
{
    ...
    public class AreaPlugin
    {
        ...
        public static int TestDirectLine(uint oArea, float fStartX, float fStartY, float fEndX, float fEndY, float fPerSpace, float fHeight, int bIgnoreDoors = 1)
        {
        ...
        public static int GetMusicIsPlaying(uint oArea, int bBattleMusic = 1)
        {
        ...
        public static int ExportGIT(uint oArea, string sFileName = "", int bExportVarTable = 1, int bExportUUID = 1, int nObjectFilter = 0, string sAlias = "NWNX")
        {
        ...
        public static void SetDefaultObjectUiDiscoveryMask(uint oArea, int nObjectTypes, int nMask, int bForceUpdate = 0)
        {
