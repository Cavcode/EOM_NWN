...
namespace EOM.Game.Server.Core.NWNX
{
    ...
    public class DialogPlugin
    {
        ...
        public static string GetCurrentNodeText(int language = NWNX_DIALOG_LANGUAGE_ENGLISH, int gender = 1)
        {
            NWNXPushInt(gender);
        ...
        /// <param name="language">The @ref dialog_languages &quot;language&quot; of the text.</param>
        /// <param name="gender">The gender for the text.</param>
        public static void SetCurrentNodeText(string text, int language = NWNX_DIALOG_LANGUAGE_ENGLISH, int gender = 1)
        {
            NWNXPushInt(gender);
            NWNXPushInt(language);
            NWNXPushString(text);
