...
namespace EOM.Game.Server.Core.NWNX
{
    ...
    public class PlayerPlugin
    {
        ...
        public static void SetAlwaysWalk(uint player, int bWalk = 1)
        {
            NWNXPushInt(bWalk);
            NWNXPushObject(player);
        ...
        public static void OpenInventory(uint player, uint target, int open = 1)
        {
            NWNXPushInt(open);
            NWNXPushObject(target);
            NWNXPushObject(player);
        ...
        public static void SetPersistentLocation(string sCDKeyOrCommunityName, string sBicFileName, uint oWP, int bFirstConnectOnly = 1)
        {
        ...
        public static int PossessCreature(uint oPossessor, uint oPossessed, int bMindImmune = 1, int bCreateDefaultQB = 0)
        {
        ...
        public static void FloatingTextStringOnCreature(uint oPlayer, uint oCreature, string sText, int bChatWindow = 1)
        {
        ...
        public static void SetTlkOverride(uint oPlayer, int nStrRef, string sOverride, int bRestoreGlobal = 1)
        {
        ...
        public static void SendPartyInvite(uint oPlayer, uint oInviter, int bForceInvite = 0, int bHideDialog = 0)
        {
