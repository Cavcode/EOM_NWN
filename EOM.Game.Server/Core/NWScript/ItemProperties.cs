...
using Alignment = EOM.Game.Server.Core.NWScript.Enum.Item.Property.Alignment;
using AlignmentGroup = EOM.Game.Server.Core.NWScript.Enum.Item.Property.AlignmentGroup;
using SpellSchool = EOM.Game.Server.Core.NWScript.Enum.SpellSchool;
