...
namespace EOM.Game.Server
{
    public class ApplicationSettings
    {
        ...
        {
            LogDirectory = Environment.GetEnvironmentVariable("EOM_APP_LOG_DIRECTORY");
            RedisIPAddress = Environment.GetEnvironmentVariable("NWNX_REDIS_HOST");

            var environment = Environment.GetEnvironmentVariable("EOM_ENVIRONMENT");
