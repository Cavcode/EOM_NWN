...
using Ability = EOM.Game.Server.Service.Ability;
using AttackType = EOM.Game.Server.Enumeration.AttackType;
using BaseItem = EOM.Game.Server.Core.NWScript.Enum.Item.BaseItem;
using FeatType = EOM.Game.Server.Core.NWScript.Enum.FeatType;
...
namespace EOM.Game.Server.Native
{
    public static unsafe class ResolveAttackRoll
    {
        ...
        private static void OnResolveAttackRoll(void* thisPtr, void* pTarget)
        {
            ...
            /*
             * Custom attack logic for EOM. Most default NWN logic does not apply.
             * 
