...
namespace EOM.Game.Server.Feature
{
    public static class EventRegistration
    {
        ...
        {
            var serverConfig = DB.Get<ModuleCache>("EOM_CACHE") ?? new ModuleCache();
        ...
        private static void HookApplicationEvents()
        {
            ...
            EventsPlugin.SubscribeEvent("EOM_COMPLETE_QUEST", "EOM_comp_qst");
            EventsPlugin.SubscribeEvent("EOM_CACHE_SKILLS_LOADED", "EOM_skl_cache");
            EventsPlugin.SubscribeEvent("EOM_COMBAT_POINT_DISTRIBUTED", "cp_xp_distribute");
            EventsPlugin.SubscribeEvent("EOM_SKILL_LOST_BY_DECAY", "EOM_lose_skill");
        }
