    ...
    public class WarocasBeastDefinition: IBeastListDefinition
    {
        ...
        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.Warocas)
                ...
                .SoundSetId(452)
                .PortraitId(168)
                .CombatStats(AbilityType.Intellect, AbilityType.Willpower)
