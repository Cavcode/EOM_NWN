...
using Item = EOM.Game.Server.Service.Item;
...
namespace EOM.Game.Server.Feature
{
    public static class UsePerkFeat
    {
        ...
        /// Requirement reductions (FP, MP, etc) are applied after the casting has completed.
        ...
        /// Requirement reductions (FP, MP, etc) are applied as soon as the ability is queued.
        /// </summary>
        /// <param name="activator">The creature activating the ability.</param>
        /// <param name="ability">The ability details</param>
