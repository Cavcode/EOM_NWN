...
using EOM.Game.Server.Service.StatService;
using EOM.Game.Server.Service.StatusEffectService;
using Player = EOM.Game.Server.Entity.Player;
using BaseItem = EOM.Game.Server.Core.NWScript.Enum.Item.BaseItem;
using EquipmentSlot = NWN.Native.API.EquipmentSlot;
using InventorySlot = EOM.Game.Server.Core.NWScript.Enum.InventorySlot;
using SavingThrow = EOM.Game.Server.Core.NWScript.Enum.SavingThrow;
...
namespace EOM.Game.Server.Service
{
    public class Stat
    {
        ...
        public static int GetEvasion(uint creature, SkillType skillOverride)
        {
            ...
            // Perception should not increase AC in EOM, so this is subtracted from the AC.
